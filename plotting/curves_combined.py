...
colors = ['#e57373', '#e57373', '#ba68c8', '#7986cb', '#81c784']
...
def get_curve(sofc_id, k):
    ...
    axs.set_ylim(bottom=-0.0024, top=0.17)
    axs.grid(False)
...
fig.legend(custom_handles, custom_labels, frameon=False, loc='center', bbox_to_anchor=(0.27, 0.78), fontsize=9)

plt.tight_layout()
plt.savefig('plots/rmse_curves.pdf', dpi=600)
plt.show()
